...
|        1         |      Instruction fetch permission fault (cross-page)       |    Next page head address     |                    0                     |
|        2         |                    Illegal instruction                     | Illegal instruction encoding  |                    0                     |
|        3         |                         Breakpoint                         | Exception instruction address |                    0                     |
|        3         |                     EBREAK instruction                     |               0               |                    0                     |
|        4         |                  LOAD address misaligned                   |     Access start address      |                    0                     |
|        5         |                 LOAD Permission Exception                  |  Actual fault start address   |                    0                     |
|        6         |                STORE/AMO Address Misaligned                |     Access start address      |                    0                     |
|        7         |               STORE/AMO permission exception               |  Actual fault start address   |                    0                     |
|        8         |                          U-ECALL                           |               0               |                    0                     |
|        9         |                          S-ECALL                           |               0               |                    0                     |
|        10        |                          VS-ECALL                          |               0               |                    0                     |
|        11        |                          M-ECALL                           |               0               |                    0                     |
|        12        |         Instruction Page Fault (Non-page-crossing)         |   Instruction start address   |                    0                     |
|        12        |           Instruction page fault (page-crossing)           |    Next page head address     |                    0                     |
|        13        |              LOAD page fault (non-cross-page)              |     Access start address      |                    0                     |
|        13        |              LOAD page fault (page-crossing)               |  Actual fault start address   |                    0                     |
|        15        |          STORE/AMO Page Fault (Non-page-crossing)          |     Access start address      |                    0                     |
|        15        |             STORE/AMO page fault (cross-page)              |  Actual fault start address   |                    0                     |
|        16        |                   Double Trap Exception                    |               0               | Trap cause code of the second exception. |
|        19        |                       Hardware error                       |  Actual fault start address   |                    0                     |
|        20        |      Guest instruction page fault (non-page-crossing)      |   Instruction start address   |            Corresponding GPA             |
|        20        |         Guest instruction page fault (cross-page)          |    Next page head address     |             Actual fault GPA             |
|        21        |           Guest LOAD page fault (non-cross-page)           |     Access start address      |            Corresponding GPA             |
|        21        |             Guest LOAD page fault (cross-page)             |  Actual fault start address   |             Actual fault GPA             |
|        22        |            Virtualization instruction exception            | Illegal instruction encoding  |                    0                     |
|        23        |       Guest STORE/AMO page fault (non-page-crossing)       |     Access start address      |            Corresponding GPA             |
|        23        |          Guest STORE/AMO Page Fault (Cross-page)           |  Actual fault start address   |             Actual fault GPA             |
