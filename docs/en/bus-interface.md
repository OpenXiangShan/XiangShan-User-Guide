...
| -------------------- | --- | ----------------------------------------------------- |
| chi_rx_linkactiveack | O   | Determine the status of RX.                           |
| chi_rx_linkactivereq | I   | Determine the status of RX.                           |
| chi_tx_linkactiveact | I   | Determine the status of TX.                           |
| chi_tx_linkactivereq | O   | Determine the status of TX.                           |
