...
| **Project Name** | **Item Count** | ** organizational structure ** | **Replacement Algorithm** | **Storage Content** |
| ---------------- | -------------- | ------------------------------ | ------------------------- | ------------------- |
...
| **Lower address bound** | **Upper Address Bound** | ** describing ** | **attribute** |
| ----------------------- | ----------------------- | ---------------- | ------------- |
...
- PMP check, confirm address read/write/execute permissions;
- Execute address access.
...
- Look up address, attribute, and permission information according to PTE;
- PMP check, confirm address read/write/execute permissions;
- Execute address access.
